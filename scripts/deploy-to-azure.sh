...
echo -e "\n${YELLOW}1. Grant Admin Consent for API Permissions:${NC}"
echo -e "   ${GRAY}Azure Portal → Azure Active Directory → App Registrations${NC}"
echo -e "   ${GRAY}→ CA Policy Manager - $WEBAPP_NAME → API permissions${NC}"
echo -e "   ${GRAY}→ Click 'Grant admin consent for [your tenant]'${NC}"
