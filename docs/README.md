...
- **QUICK_START_LOCAL.md** - Local environment quick setup
...
- **GITHUB_PREP.md** - Preparing for GitHub publication (moved to archive if missing)
- **PRE_PUBLICATION_SECURITY_CHECKLIST.md** - Security review checklist (moved to archive if missing)
...
- **README_NEW.md** - Deprecated (merged into main README)
